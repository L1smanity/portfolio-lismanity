...
const Who: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="w-full md:w-[75%] bg-[rgb(207, 207, 207)] text-black p-10 rounded-xl border-white border-r-gray-700 border-b-gray-700 border-l-gray-500 border-t-gray-500 shadow-[inset_-2px_-2px_0px_#fff,inset_2px_2px_0px_#808080] transition-all duration-300">
        ...
        {/* Description */}
        <p className="text-lg font-semibold   font-mono leading-7 tracking-wider text-center text-black">
          ...
          visuals with <span className="font-bold ">Three.js</span>, to
          designing pixel-perfect mockups in{" "}
        ...
        {/* Additional Details */}
        <p className="text-lg  font-mono text-center font-semibold  text-black">
